<x-action-section>
    ...
    <x-slot name="description">
        {{ __('إدارة وتسجيل خروج جلساتك النشطة على المتصفحات والأجهزة الأخرى.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('إذا لزم الأمر، يمكنك تسجيل الخروج من جميع جلساتك الأخرى على المتصفحات عبر جميع أجهزتك. يتم عرض بعض جلساتك الأخيرة أدناه. ومع ذلك، قد لا يكون هذا القائمة شاملة. إذا كنت تشعر أن حسابك قد تم اختراقه، يجب عليك أيضًا تحديث كلمة المرور الخاصة بك.') }}
        </div>
        ...
        <x-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                ...
                <div class="mt-4" x-data="{}"
                    ...
                    <x-input type="password" class="mt-1 block w-3/4" autocomplete="current-password"
                        placeholder="{{ __('كلمة السر') }}" x-ref="password" wire:model.defer="password"
            ...
            <x-slot name="footer">
                ...
                <x-button class="mr-3" wire:click="logoutOtherBrowserSessions" wire:loading.attr="disabled">
                    {{ __('تسجيل الخروج من جلسات المتصفح الأخرى') }}
                </x-button>
            </x-slot>
        </x-dialog-modal>
