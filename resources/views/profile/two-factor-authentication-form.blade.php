<x-action-section>
    <x-slot name="title">
        {{ __(' المصادقة الثنائية العاملة') }}
    </x-slot>

    <x-slot name="description">
        {{ __('أضف حماية إضافية لحسابك باستخدام المصادقة الثنائية .') }}
    </x-slot>
            ...
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        ...
                        @else
                            {{ __('تم تمكين المصادقة الثنائية الآن. امسح رمز الاستجابة السريعة التالي ضوئيًا باستخدام تطبيق المصادقة بهاتفك أو أدخل مفتاح الإعداد.') }}
                        @endif
                    </p>
                </div>
