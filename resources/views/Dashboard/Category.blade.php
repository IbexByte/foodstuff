        ...
        <table id="categories" class="min-w-max w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    <th class="py-3 px-6 text-left">إسم الصنف</th>
                    <th class="py-3 px-6 text-left">معرف الصنف</th>
                    <th class="py-3 px-6 text-center">وصف</th>
                    <th class="py-3 px-6 text-center">عدد العناصر</th>
