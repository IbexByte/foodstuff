        ...
        <table id="job_titles" class="min-w-max w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 text-center">الشحنات التي لها نفس الحالة</th>
                ...
                @foreach ($statutes as $status)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            @foreach ($status->shipments as $shipment)
                                <ol>
                                    <li>
                                        {{ $shipment->name }}
                                    </li>
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                ...
                                <form action="{{ route('statutes.destroy', $status->id) }}" method="POST">
                                    @csrf
