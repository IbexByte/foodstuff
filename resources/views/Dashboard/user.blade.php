        ...
        <table id="users" class="min-w-max w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    <th class="py-3 px-6 text-left">اسم العضو</th>
                    <th class="py-3 px-6 text-left">معرف العضو</th>
                    <th class="py-3 px-6 text-center">بريده الإلكتروني</th>
                    <th class="py-3 px-6 text-center">المسى الوظيفي</th>
            ...
            <tbody class="text-gray-600 text-sm">
                ...
                @foreach ($users as $user)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            @if ($user->jobTitle && $user->jobTitle->title)
                                {{ $user->jobTitle->title }}
                            @else
                                ليس لهذا المستخدم أي مسمى وظيفي بعد.
                            @endif
