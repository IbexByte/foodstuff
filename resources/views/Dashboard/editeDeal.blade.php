        ...
        <section class="pt-20 pb-10 lg:pt-[120px] lg:pb-20">
            <form action="{{ route('deal.update', $deal->id) }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="mb-12">
                    ...
                    <input name="name" id="name" type="text" value="{{$deal->name}}" placeholder="اسم للصفقة"
                ...
                <div class="mb-12">
                    ...
                    <textarea name="description" id="description" rows="5" placeholder="وصف للصفقة"
                        class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]"> {{$deal->description}} </textarea>
                    @error('description')
                        <span class="text-red-600 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-12">
                    ...
                    <input name="youtube_link" id="youtube_link" type="url" placeholder="اسم للصفقة"
                        class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                    @error('youtube_link')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-12">
                        ...
                        <input  value="{{$deal->price}}"   name="price" type="number" placeholder="قيمة الصفقة"
                            class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]" />
                        @if ($errors->has('price'))
                ...
                <div class="relative max-w-sm">
                    ...
                    <input  value="{{$deal->start_date}}"  name="start_date" type="date" id="start_date"
                ...
                <div class="relative max-w-sm">
                    ...
                    <input   value="{{$deal->end_date}}"  name="end_date" type="date" id="end_date"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="mb-12">
                    <label for="requirement" class="mb-3 block text-base font-medium text-black">
                        متطلبات وشروط التقدم للصفقة :
                    </label>
                    <textarea name="requirement" id="requirement" rows="5" placeholder="شروط ومتطلبات الصفقة"
                        class="w-full rounded-lg border-[1.5px] border-form-stroke py-3 px-5 font-medium text-body-color placeholder-body-color outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD]"> {{$deal->requirement}} </textarea>
