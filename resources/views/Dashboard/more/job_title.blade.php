        ...
        <table id="job_titles" class="min-w-max w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    <th class="py-3 px-6 text-left">المسمى الوضيفي</th>
                    <th class="py-3 px-6 text-left">معرف المسمى</th>
                    <th class="py-3 px-6 text-center">الأعضاء</th>
                ...
                @foreach ($jobTitles as $job_title)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        <td class="py-3 px-6 text-left whitespace-nowrap">
                            <p>{{ $job_title->title }} - {{ $job_title->users_count }} عضو</p>
                        </td>
                        ...
                        <td class="py-3 px-6 text-center">
                            @foreach ($job_title->users as $user)
                                <ol>
                                    <li>
                                        {{ $user->name }}
                                    </li>
