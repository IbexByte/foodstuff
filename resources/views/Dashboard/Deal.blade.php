...
@section('content')
    ...
    <div class="bg-white shadow rounded-sm my-2.5 overflow-x-auto">
        ...
        <table id="deals" class="min-w-max w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    <th class="py-3 px-6 text-left">إسم الصفقة</th>
                    <th class="py-3 px-6 text-left">معرف الصفقة</th>
                    <th class="py-3 px-6 text-center">وصف</th>
                    <th class="py-3 px-6 text-center">القيمة</th>
    ...
    <script>
        // let table = new DataTable('#deals');
        var table = new DataTable('#deals', {
            language: {
