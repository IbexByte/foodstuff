...
@section('content')
    ...
    <div class="bg-white shadow rounded-sm my-2.5 overflow-x-auto">
        ...
        <table id="customers" class="min-w-max w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    <th class="py-3 px-6 text-left">إسم العميل</th>
                    <th class="py-3 px-6 text-left">معرف العميل</th>
                    <th class="py-3 px-6 text-center">رقم هاتفه</th>
                    <th class="py-3 px-6 text-center">بريده الإلكتروني</th>
                ...
                @foreach ($customers as $customer)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-left">
                            {{ Str::limit( $customer->deal->name , 50, '...')}}
                        </td>
