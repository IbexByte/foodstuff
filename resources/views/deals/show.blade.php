...
@section('content')
    ...
    <section class="pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        ...
        @if (Session::has('success'))
            <div class="w-full bg-lime-300 rounded-md p-5  z-50">
            ...
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative z-20 mb-[60px] h-[300px] overflow-hidden rounded md:h-[400px] lg:h-[500px]"
                        data-wow-delay=".1s
                ">
                        <img src="{{ asset('storage/hero11.gif') }}" alt="image"
                            ...
                            <div class="flex flex-wrap items-center p-4 pb-4 sm:p-8">
                                <div class="mb-4 mr-5 flex items-center md:mr-10">
                                    ...
                                    <div class="mr-4 h-10 w-10 overflow-hidden rounded-full">
                                        <img src="{{ asset('storage/avatar/man.webp') }}" alt="image" class="w-full" />
                                    </div>
                                </div>
                                <div class="mb-4 flex items-center">
                                    ...
                                    {{-- <p class="ml-5 flex items-center text-sm font-medium text-white md:mr-8">
                    ...
                    <div class="-mx-4 flex flex-wrap">
                        <div class="w-full px-4 lg:w-8/12">
                            <div>
                                <h2 class="wow fadeInUp mb-6 text-[26px] font-bold leading-snug text-dark sm:text-3xl sm:leading-snug md:text-4xl md:leading-snug"
                                    data-wow-delay=".1s
                      ">
                                    {{ $deal->name }}
                                </h2>
                                @php $counter = 2; @endphp
                                @foreach (explode('.', $deal->description) as $paragraph)
                                    @php $counter++; @endphp
                                    <p class="wow fadeInUp mb-8 text-base leading-relaxed text-body-color"
                                        data-wow-delay="{{ $counter * 0.1 }}s">
                                        {{ $paragraph }}
                                    </p>
                                @endforeach
                                {{-- شروط الصفقات --}}
                                <div
                                    ...
                                    <div class="w-full">
                                        <h5 class="mb-3 text-lg font-semibold text-[#9D5425]">
                                            ضرورة الانتباه إلى شروط الصفقات المقدمة
                                        </h5>
                                        <p class="text-base leading-relaxed text-[#D0915C]">
                                            تعتبر الشروط التي نطلبها في صفقاتنا المقدمة للمواد الغذائية بالجملة في المملكة
                                            العربية السعودية أمرًا حيويًا وضروريًا يجب الانتباه إليه بشكل كبير. </p>
                                    </div>
                                </div>
                                <div class="w-full px-4 ">
                                    <div class="mb-12 w-full">
                                        <ol>
                                            ...
                                            @foreach (explode('.', $deal->requirement) as $item)
                                                <li class="mb-4   flex text-base text-body-color"
                                                    data-wow-delay="{{ $listCounter * 0.1 }}s">
                                                    <span
                                                        class="ml-2  flex h-6 w-full max-w-[24px] items-center justify-center rounded-full bg-primary text-base text-white">
                                                        {{ $listCounter }}
                                                    </span>
                                                    {{ $item }}
                                ...
                                <p class="wow fadeInUp mb-10 text-base leading-relaxed text-body-color"
                                    data-wow-delay=".1s">
                                    بعد الإتفاق على شروط الصفقة وتأكيد الطلب، سيتم إجراء عملية الشحن والتوريد من المورد إلى
                                    المشتري في المملكة العربية السعودية. كما ستتم متابعة الشحنة من خلال فريق الدعم الخاص
                                    بالشركة لضمان وصولها في الوقت المحدد ودون أي تأخير. وبمجرد وصول الشحنة إلى المشتري، سيتم
                                    إجراء عملية التفريغ والتحميل بسرعة وكفاءة للتأكد من وصول المواد الغذائية بحالة جيدة
                                    ومناسبة للاستهلاك.



                                </p>
                                <div class="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded bg-primary bg-opacity-5 py-8 px-6 text-center sm:p-10 md:px-[60px]"
                                    data-wow-delay=".1s
                      ">
                                    <div class="mx-auto max-w-[530px]">
                                        ...
                                        <p class="mb-4 text-base font-medium italic leading-[26px] text-dark">
                                            نعتز بتقديم صفقات مميزة لعملائنا الكرام في قطاع تجارة المواد الغذائية بالجملة.
                                            نحن نفهم تمامًا ما يحتاجه عملاؤنا من حيث الجودة والكمية والسعر المناسب، ولذلك
                                            نسعى دائمًا لتقديم أفضل العروض لهم.
                                ...
                                <h3 class="wow fadeInUp mb-8 text-2xl font-bold text-dark sm:text-[26px]"
                                    data-wow-delay=".1s">
                                    شكرًا لتعاملكم معنا ونتطلع إلى التعاون المستقبلي في تجارة المواد الغذائية بالجملة
                                </h3>

                                <p class="wow fadeInUp mb-8 text-base leading-relaxed text-body-color"
                                    data-wow-delay=".1s">
                                    "شكراً لثقتكم بموقعنا ونحن سعداء جداً بتعاملنا معكم في هذه الصفقة الكبرى لتجارة المواد
                                    الغذائية بالجملة. نحن نؤمن بأن هذه الصفقة ستكون بداية نجاحكم ونجاحنا معاً. بعد النقر على
                                    الاشتراك في الصفقة، ستتلقون رسالة تأكيدية منا، ونحن نعدكم بالرد عليكم في أقرب وقت ممكن.
                                    نتمنى لكم كل التوفيق في مشروعكم ونتطلع إلى التعامل معكم مرة أخرى في المستقبل."



                                </p>
                                {{-- <p class="wow fadeInUp mb-11 text-base leading-relaxed text-body-color"
                                    data-wow-delay=".1s">
                      ...
                      ">
                                    ...
                                    <form method="POST" action="{{ route('deals.store') }}">
                                        ...
                                        <input type="text" name="name" placeholder="إسمك الكامل"
                                        ...
                                        @error('email')
                                            <div class="text-red-500">{{ $message }}</div>
                                        @enderror
                                        <input type="hidden" id="phone_key" name="phone_key" value="">
                                        <input id="phone" type="tel" name="phone_number"
                                            placeholder="رقم الهاتف"
                                            class=" my-4 h-[50px] w-[100%] px-14 rounded border border-transparent bg-white bg-opacity-20 text-center text-sm font-medium text-white placeholder-white outline-none focus:border-white focus-visible:shadow-none"
                                            value="{{ old('phone_number') }}" />
                                        @error('phone_number')
                                            <div class="text-red-500">{{ $message }}</div>
                                        @enderror
                                        <input type="submit" value="تقدم الآن"
                                            class="my-6 h-[50px] w-full cursor-pointer rounded bg-[#13C296] text-center text-sm font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-90 hover:shadow-lg" />
                                    </form>

                                    <p class="text-sm font-medium text-white">
                                        بعد ذلك تفقد قدوم رسالة على هاتفك
                                    </p>
                                    {{-- var input = document.querySelector("#phone");
                                    var phoneKeyInput = document.querySelector("#phone_key");
                                    ...
                                    <script>
                                        ...
                                        form.addEventListener("submit", function(event) {
                                            ...
                                            var phoneKey = iti.getNumber(intlTelInputUtils.numberFormat.E164);
                          ...
                          ">
                                            <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                                                <img src="https://picsum.photos/id/237/200/200" alt="image"
                                                    class="w-full" />
                                            </div>
                                            <div class="w-full">
                                                <h4>
                          ...
                          ">
                                            <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                                                <img src="https://picsum.photos/id/17/200/200" alt="image"
                                                    class="w-full" />
                                            </div>
                                            <div class="w-full">
                                                <h4>
                          ...
                          ">
                                            <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                                                <img src="https://picsum.photos/id/287/200/200" alt="image"
                                                    class="w-full" />
                                            </div>
                                            <div class="w-full">
                                                <h4>
                                    ...
                                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                                        <div class="wow fadeInUp mb-5 flex w-full items-center border-0 border-[#F2F3F8] pb-5 md:border-b lg:border-0"
                                            data-wow-delay=".1s
                          ">
                                            <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                                                <img src="https://picsum.photos/id/211/200/200" alt="image"
                                                    class="w-full" />
                                            </div>
                                            <div class="w-full">
                                                <h4>
                                ...
                                <div class="wow fadeInUp mb-12 overflow-hidden rounded" data-wow-delay=".1s">
                                    <img src="https://picsum.photos/id/117/200/200" alt="image" class="w-full" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="-mx-4 flex flex-wrap">
                    ...
                    <div class="wow fadeInUp group mb-10" data-wow-delay=".1s">
                        <div class="mb-8 overflow-hidden rounded">
                            <a href="blog-details.html" class="block">
                                <img src="https://picsum.photos/id/222/200/200" alt="image"
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="wow fadeInUp group mb-10" data-wow-delay=".15s">
                        <div class="mb-8 overflow-hidden rounded">
                            <a href="blog-details.html" class="block">
                                <img src="https://picsum.photos/id/223/200/200" alt="image"
                                    class="w-full transition group-hover:rotate-6 group-hover:scale-125" />
                            </a>
                        </div>
                        <div>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="wow fadeInUp group mb-10" data-wow-delay=".2s">
                        <div class="mb-8 overflow-hidden rounded">
                            <a href="blog-details.html" class="block">
                                <img src="https://picsum.photos/id/224/200/200" alt="image"
                                    class="w-full transition group-hover:rotate-6 group-hover:scale-125" />
                            </a>
                        </div>
                        <div>
