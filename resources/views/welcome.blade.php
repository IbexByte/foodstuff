            ...
            <div class="-mx-4 flex flex-wrap items-center">
                <div class="w-full px-4">
                    ...
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        ...
                        <h1 id="arabic-text"
                            ...
                            استيراد المواد الغذائية بالجملة من كافة أنحاء العالم
                        </h1>


                        <p
                            class="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed">
                            مؤسسة استيراد المواد الغذائية الرائدة، تقدم خدمات استيراد المواد الغذائية بالجملة بأفضل الأسعار
                            وأعلى جودة. تصفح الآن لتستكشف خيارات الاستثمار والوكالات التجارية والمزيد
                        </p>
                ...
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                        <div class="mt-16">
                            <img src="{{ asset('storage/hero11.gif') }}" alt="hero"
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="mb-12 max-w-[620px] lg:mb-20">
                        ...
                        <h2 class="mb-4 leading-10 text-3xl  text-dark sm:text-4xl md:text-[35px]">
                            نحن نوفر لكم أفضل الخدمات والأسعار في استيراد المواد الغذائية بالجملة
                        </h2>
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
                        ...
                        <h4 class="mb-3 text-xl font-bold text-dark">
                            جودة منتجاتنا والمصادر الموثوقة
                        </h4>
                        <p class="mb-8 text-body-color lg:mb-11">
                            تعتمد هذه الميزة على اختيارنا للموردين الذين يوفرون منتجات عالية الجودة والتي تلبي معايير
                            السلامة الغذائية والصحية، مما يضمن لعملائنا الحصول على منتجات ممتازة
                        </p>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".15s">
                        ...
                        <h4 class="mb-3 text-xl font-bold text-dark">
                            توفير الوقت والجهد </h4>
                        <p class="mb-8 text-body-color lg:mb-11">
                            نحن نتولى عناء البحث عن المنتجات المطلوبة والتعامل مع الموردين والجمارك، مما يوفر الوقت والجهد
                            لعملائنا ويساعدهم على التركيز على عملياتهم الأساسية </p>
                        <a href="javascript:void(0)" class="text-base font-medium text-body-color hover:text-primary">
                            إطلع على المزيد
                        </a>
                    </div>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
                        ...
                        <h4 class="mb-3 text-xl font-bold text-dark">
                            تنوع الخيارات </h4>
                        <p class="mb-8 text-body-color lg:mb-11">
                            نحن نوفر مجموعة واسعة من المنتجات الغذائية الشاملة، وذلك بفضل علاقاتنا الوثيقة مع مختلف
                            الموردين، مما يتيح لعملائنا الاختيار من بين مجموعة متنوعة من المنتجات التي تلبي احتياجاتهم. </p>
                        <a href="javascript:void(0)" class="text-base font-medium text-body-color hover:text-primary">
                            إطلع على المزيد
                        </a>
                    </div>
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".25s">
                        ...
                        <h4 class="mb-3 text-xl font-bold text-dark">
                            توفير التكاليف </h4>
                        <p class="mb-8 text-body-color lg:mb-11">
                            بفضل تعاملنا المباشر مع الموردين واستيرادنا للمنتجات بالجملة، نحن قادرون على تقديم الأسعار
                            التنافسية وتوفير التكاليف لعملائنا. </p>
                        <a href="javascript:void(0)" class="text-base font-medium text-body-color hover:text-primary">
                            إطلع على المزيد
                        </a>
                    </div>
                        ...
                        <div class="items-center justify-between overflow-hidden border lg:flex">
                            <div
                                ...
                                <p class="mb-9 text-base leading-relaxed text-body-color">
                                    كانت شركتنا ملتزمة بتقديم أفضل الخدمات والمنتجات لعملائنا جميع أنحاء المملكة. بدأت
                                    شركتنا كفكرة بسيطة ولكنها كبرت مع الوقت إلى أن أصبحت واحدة من أبرز الشركات في مجالها.
                                    تحقق هذا النجاح بفضل الجهود الشاقة لفريق العمل الذي يعمل بكل تفانٍ لتلبية احتياجات
                                    العملاء وتحقيق رؤيتنا لتحسين حياة الناس وتسهيل حياتهم. </p>
                                <p class="mb-9 text-base leading-relaxed text-body-color">
                                    في رحلة نجاحنا، تعلمنا الكثير من الدروس والخبرات التي ساعدتنا على التطور والنمو. والآن،
                                    نحن مستعدون لتوسيع عملنا والعمل على تحقيق المزيد من الأهداف والطموحات. فإن تاريخنا يدعم
                                    بشكل قوي رؤيتنا للمستقبل ونحن نسعى جاهدين للمضي قدمًا وتقديم المزيد من الابتكارات
                                    والحلول الفعالة لتلبية احتياجات عملائنا في جميع أنحاء العالم.
                            ...
                            <div class="text-center">
                                <div class="relative z-10 inline-block">
                                    <img src="{{ asset('storage/hero1.jpg') }}" alt="image"
                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
                        ...
                        <h2 class="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[40px]">
                            تجارة الجملة للمواد الغذائية </h2>
                        <p class="text-base text-body-color">
                            نقدم خدمات تجارة الجملة للمواد الغذائية، حيث نقوم بالاستيراد والتصدير بالحاويات لتلبية احتياجات
                            السوق داخل المملكة العربية السعودية. ونسعى دائماً إلى تحسين جودة ومجموعة منتجاتنا، بالإضافة إلى
                            توفير خدمات
                            شحن وتخزين وتسليم سريعة وفعالة لعملائنا </p>
                    </div>
                </div>
            </div>
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        <div class="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl ">
                          <img src="{{ asset('storage/icon/container.svg') }}" alt="">
                            
                        </div>
                        <h4 class="mb-3 text-xl font-semibold text-dark">
                            توريد المواد الغذائية العالمية
                        </h4>
                        <p class="text-body-color">
                            توفر الشركة مجموعة واسعة من المواد الغذائية المستوردة بالجملة من مصادر عالمية مختلفة.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        <div class="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl ">
                            <img src="{{ asset('storage/icon/distribution.svg') }}" alt="">

                        </div>
                        <h4 class="mb-3 text-xl font-semibold text-dark">
                            خدمات التخزين والتوزيع
                        </h4>
                        <p class="text-body-color">
                            توفر الشركة خدمات تخزين وتوزيع المواد الغذائية للشركات العاملة في قطاعات الضيافة والتجزئة.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        <div class="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl ">
                            <img src="{{ asset('storage/icon/search.svg') }}" alt="">

                        </div>
                        <h4 class="mb-3 text-xl font-semibold text-dark">
                            البحث عن المنتجات المخصصة
                        </h4>
                        <p class="text-body-color">
                            تساعد الشركة العملاء في العثور على المنتجات المخصصة التي يحتاجون إليها وتوريدها لهم.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        <div class="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-full bg-green-500">
                            <img src="{{ asset('storage/icon/logistic.svg') }}" alt="">
                        ...
                        <p class="text-body-color">
                            توفر الشركة خدمات الدعم اللوجستي لضمان توفير المواد الغذائية بشكل فعال وفي الوقت المناسب.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        <div class="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl ">
                            <img src="{{ asset('storage/icon/health.svg') }}" alt="">
                        </div>
                        <h4 class="mb-3 text-xl font-semibold text-dark">
                            الاستشارات الغذائية
                        </h4>
                        <p class="text-body-color">
                            توفر الشركة خدمات الاستشارات الغذائية للعملاء والشركات العاملة في قطاع الغذاء
                            . </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-8 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10">
                        <div class="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-full ">
                            <img src="{{ asset('storage/icon/quality.svg') }}" alt="">

                        </div>
                        <h4 class="mb-3 text-xl font-semibold text-dark">
                            الجودة والامتثال </h4>
                        <p class="text-body-color">
                            تعمل الشركة بشكل وثيق مع الشركات المصنعة لضمان الامتثال لمعايير الجودة العالمية والمحلية في جميع
                            مراحل التوريد والتوزيع.
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                        ...
                        <h2 class="mb-4 text-3xl  text-dark sm:text-4xl md:text-[42px]">
                            تعرّف على أكثر الأسئلة الشائعة حول خدماتنا ومنتجاتنا
                        </h2>
                        <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                            نحن ندرك أن لديك الكثير من الأسئلة حول خدماتنا ومنتجاتنا، ولذلك نحن هنا لنقدم لك إجابات شاملة
                            على أسئلتك الشائعة. تحقق من الأسئلة الشائعة التالية لمعرفة المزيد عن شركتنا وخدماتنا.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="-mx-4 flex flex-wrap">
                ...
                ">
                        ...
                        <div class="faq-content hidden pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                نحن شركة تجارة بالجملة للمواد الغذائية في المملكة العربية السعودية، حيث نستورد المواد الغذائية بالجملة بالحاويات ونقوم بتوزيعها للمتاجر والموردين.
                            </p>
                        </div>
                    </div>
                    <div class="single-faq wow fadeInUp mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-5 sm:p-8"
                ...
                ">
                        <button class="faq-btn flex w-full items-center text-left">
                            ...
                            <div class="w-full">
                                <h4 class="text-base font-semibold text-black sm:text-lg">
                                    هل تقدمون خدمات التوصيل؟
                                </h4>
                            </div>
                        </button>
                        <div class="faq-content hidden pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                نعم، نقدم خدمات التوصيل لعملائنا في جميع أنحاء المملكة العربية السعودية.
                            </p>
                        </div>
                    </div>
                    <div class="single-faq wow fadeInUp mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-5 sm:p-8"
                ...
                ">
                        <button class="faq-btn flex w-full items-center text-left">
                            ...
                            <div class="w-full">
                                <h4 class="text-base font-semibold text-black sm:text-lg">
                                    هل تستوردون منتجات غذائية عالية الجودة؟
                                </h4>
                            </div>
                        </button>
                        <div class="faq-content hidden pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                نعم، نحرص على توريد منتجات غذائية عالية الجودة والمعتمدة من المصادر الموثوقة.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                ">
                        <button class="faq-btn flex w-full items-center text-left">
                            ...
                            <div class="w-full">
                                <h4 class="text-base font-semibold text-black sm:text-lg">
                                    كيف يمكنني طلب المنتجات منكم؟
                                </h4>
                            </div>
                        </button>
                        <div class="faq-content hidden pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                يمكنك طلب المنتجات من خلال التواصل معنا عبر البريد الإلكتروني أو الهاتف، وسنكون سعداء بتلقي طلبك.
                            </p>
                        </div>
                    </div>
                    <div class="single-faq wow fadeInUp mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-5 sm:p-8"
                ...
                ">
                        ...
                        <div class="faq-content hidden pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                نعم، لدينا فريق عملاء متخصص يساعد العملاء في حل أي مشكلة أو الإجابة على أي استفسار.
                            </p>
                        </div>
                    </div>
                    <div class="single-faq wow fadeInUp mb-8 w-full rounded-lg border border-[#F3F4FE] bg-white p-5 sm:p-8"
                ...
                ">
                        <button class="faq-btn flex w-full items-center text-left">
                            ...
                            <div class="w-full">
                                <h4 class="text-base font-semibold text-black sm:text-lg">
                                    هل تقدمون عروضًا وتخفيضات؟
                                </h4>
                            </div>
                        </button>
                        <div class="faq-content hidden pl-[62px]">
                            <p class="py-3 text-base leading-relaxed text-body-color">
                                نعم، نقدم عروضًا وتخفيضات من وقت لآخر، تابعونا على مواقع التواصل الاجتماعي للاطلاع على آخ
        ...
        <div class="container px-4">
                ...
                <div class="mx-4 w-full">
                    <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
                        ...
                        <h2 class="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">
                            تجارب عملائنا مع شركتنا
                        </h2>
                        <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                            في شركتنا، نحن ملتزمون بتقديم أفضل الخدمات والمنتجات لعملائنا، ونسعى دائماً لتحسين تجربتهم معنا. لقد جمعنا بعض التعليقات والتجارب التي حصلنا عليها من عملائنا والتي نفخر بها                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-wrap">
                ...
                ">
                        ...
                        <div class="ud-testimonial-content mb-6">
                            <p class="text-base tracking-wide text-body-color">
                                شركة رائعة ومتميزة في مجال تجارة المواد الغذائية، تعاملت معهم في عدة مشاريع وكانت تجربة رائعة ومرضية للغاية                            </p>
                        </div>
                        <div class="ud-testimonial-info flex items-center">
                            ...
                            <div class="ud-testimonial-meta">
                                <h4 class="text-sm font-semibold">أحمد الشهري</h4>
                                <p class="text-xs text-[#969696]">صاحب سوبر ماركت</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ">
                        ...
                        <div class="ud-testimonial-content mb-6">
                            <p class="text-base tracking-wide text-body-color">
                                أشكر شركة تجارة الجملة على جودة خدماتهم وتعاملهم الراقي مع العملاء، فهم يسعون دائماً لتلبية احتياجات العملاء بأفضل جودة وبأسعار مناسبة
                            </p>
                        </div>
                        <div class="ud-testimonial-info flex items-center">
                            <div class="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                            ...
                            <div class="ud-testimonial-meta">
                                <h4 class="text-sm font-semibold">هند المطيري</h4>
                                <p class="text-xs text-[#969696]">مالكة مؤسسة حلويات</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ">
                        ...
                        <div class="ud-testimonial-content mb-6">
                            <p class="text-base tracking-wide text-body-color">
                                تعاونت مع شركة تجارة الجملة في توريد مواد غذائية لمطاعمي ، وكانت الخدمة سريعة وممتازة، كما أن الجودة لا تقارن بأي شركة أخرى، شكرًا لفريق العمل المحترف                            </p>
                        </div>
                        <div class="ud-testimonial-info flex items-center">
                            <div class="ud-testimonial-image mr-5 h-[50px] w-[50px] overflow-hidden rounded-full">
                            ...
                            <div class="ud-testimonial-meta">
                                <h4 class="text-sm font-semibold">محمد العتيبي</h4>
                                <p class="text-xs text-[#969696]">مدير سلسلة مطاعم</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container px-4">
            <div class="-mx-4 flex flex-wrap items-center">
                    ...
                    <div class="ud-contact-content-wrapper">
                        ...
                        <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                            <div class="mb-8 flex w-[330px] max-w-full">
                                <div class="ml-6 text-[32px] text-primary">
                                ...
                                <div>
                                    <h5 class="mb-6 text-lg font-semibold">موقعنا</h5>
                                    <p class="text-base text-body-color">
                            ...
                            <div class="mb-8 flex w-[330px] max-w-full">
                                ...
                                <div>
                                    <h5 class="mb-6 text-lg font-semibold">كيف يمكننا مساعدتك ؟</h5>
                                    <p class="text-base text-body-color">info@foodStuff.com</p>
                                    <p class="text-base text-body-color">
                                        contact@foodStuff.com
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                ">
                        ...
                        <form>
                            <div class="mb-6">
                                <label for="fullName" class="block text-xs text-dark">الإسم الكامل*</label>
                                <input type="text" name="fullName" placeholder="أحمد محمد"
                                    class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                            </div>
                            <div class="mb-6">
                                <label for="email" class="block text-xs text-dark">بريدك الإلكتروني*</label>
                                <input type="email" name="email" placeholder="example@yourmail.com"
                                    class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                            </div>
                            <div class="mb-6">
                                <label for="phone" class="block text-xs text-dark">رقم هاتفك*</label>
                                <input type="text" name="phone" placeholder="+885 1254 5211 552"
                                    class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
                            </div>
                            <div class="mb-6">
                                <label for="message" class="block text-xs text-dark">الرسالة*</label>
                                <textarea name="message" rows="1" placeholder="أكتب رسالتك هنا"
